Sub BuildSimulationInput()
    ...
    ' Sheet references - using the new sheet structure
    Set wsConfig = ThisWorkbook.Sheets(16)  ' シミュレーション設定
    Set wsPlan = ThisWorkbook.Sheets(2)     ' 生産計画
    Set wsOut = ThisWorkbook.Sheets(17)     ' シミュレーションイン
    Set wsMaster = ThisWorkbook.Sheets(6)   ' 品目マスタ
    ...
    ' Read config from シミュレーション設定 (Sheet 16), B1 and B2
